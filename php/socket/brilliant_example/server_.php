...
socket_listen($socket); //listen to porty
...
//		$messages_to_send = check_for_new_sendable();
//		foreach ($messages_to_send as $message_to_send) {
...
//			send_message($users_tokens, $response_text); //send data
//		} 
...
function check_for_new_sendable () {
	global $messages;
	//open a cache, get datas
}
